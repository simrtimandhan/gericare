import { ActivityIndicator, Alert, Image, Linking, RefreshControl, SafeAreaView, ScrollView, Text, TouchableOpacity, View } from "react-native"
...
const HelperDashboard = ({ navigation }) => {
    useNotification()
    ...
    return (
        ...
        <ScrollView refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} />}>
            <View style={{ margin: 24 }}>
                ...
                {
                    heleperRequest && heleperRequest?.slice(0, 1)?.map((request, index) => {
                        return (
